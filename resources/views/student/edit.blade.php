...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-md-8 col-lg-6">
            ...
            <div class="row">
                <div class="col-xs-6">
                    <img id="anh_the_preview" src="{{ $student->image? Storage::url($student->image): ':https://png.pngtree.com/element_our/png/20181206/users-vector-icon-png_260862.jpg' }}" alt="your image" style="max-width: 200px; height:100px; margin-bottom: 10px;" class="img-fluid" />
                    ...
                    <label for="cmt_truoc">Ảnh thẻ</label><br />
                        ...
                        <button type="submit" class="btn btn-primary btn-block mt-2">edit</button>
                    </form>
                </div>
            </div>
        </div>
